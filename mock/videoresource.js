...
for (let i = 0; i < count; i++) {
  List.push(
    Mock.mock({
      ...
      "status|1": ["Shooting", "Finished", "Pending"],
      views: "@integer(3000, 5000)",
      downloads: "@integer(300, 600)",
      "satellite|1": ["Satellite 01", "Satellite 02", "Satellite 03"],
      user_id: function () {
        return "userid" + Random.integer(300, 5000);
      },
      ...
      "slots|1": ["2022/03/18 17:00 - 2022/03/18 18:00"],
      "type|1": ["Live", "Appointment"],
